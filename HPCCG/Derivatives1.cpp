  ...
  _label0:
    ...
    for (; _t120; _t120--) {
        ...
        }
        {
            ...
            double _r56 = _r_d30 * numerical_diff::forward_central_difference(fabs, clad::pop(_t125), 0, 0, clad::pop(_t125));
    ...
    _final_error += _delta_normr + _delta_diff + _delta_sum + _delta_beta + _delta_rtrans + _delta_tolerance + _delta_residual + _delta_oldrtrans;
}
