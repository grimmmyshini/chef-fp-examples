...
void HPCCG_residual_grad(double *b, double *x, double *xexact, double *r, double *p, double *Ap, clad::array_ref<double> _d_b, clad::array_ref<double> _d_x, clad::array_ref<double> _d_xexact, clad::array_ref<double> _d_r, clad::array_ref<double> _d_p, clad::array_ref<double> _d_Ap, double &_final_error, std::ostream &_error_stream) {
  ...
  _label0:
    ...
    for (; _t41; _t41--) {
        ...
        }
        {
            for (; clad::back(_t102); clad::back(_t102)--) {
                ...
                double _r_d21 = _d_r[_t104];
                int _t106 = clad::pop(_t105);
                _d_r[_t106] += _r_d21;
                double _r56 = _r_d21 * clad::pop(_t107);
                _d_beta += _r56;
                double _r57 = clad::pop(_t108) * _r_d21;
        ...
        }
        {
            for (; clad::back(_t93); clad::back(_t93)--) {
                ...
                double _r_d19 = _d_x[_t95];
                int _t97 = clad::pop(_t96);
                _d_x[_t97] += _r_d19;
                double _r51 = _r_d19 * clad::pop(_t98);
                _d_beta += _r51;
                double _r52 = clad::pop(_t99) * _r_d19;
        ...
        {
            double _r_d18 = _d_beta;
            double _r47 = clad::pop(_t91);
            double _r48 = _r_d18 / _r47;
            _d_rtrans += _r48;
            ...
            for (; clad::back(_t69); clad::back(_t69)--) {
                {
                    for (; clad::back(_t72); clad::back(_t72)--) {
                        int _t74 = clad::pop(_t73);
                        double _r_d16 = _d_Ap[_t74];
                        _d_Ap[_t74] += _r_d16;
                        double _r37 = _r_d16 * clad::pop(_t75);
                        int _t77 = clad::pop(_t76);
                        int _t79 = clad::pop(_t78);
                        double _r38 = clad::pop(_t80) * _r_d16;
        ...
        if (clad::pop(_t43)) {
            {
                for (; clad::back(_t44); clad::back(_t44)--) {
                    ...
                    double _r_d9 = _d_p[_t46];
                    int _t48 = clad::pop(_t47);
                    _d_r[_t48] += _r_d9;
                    double _r17 = _r_d9 * clad::pop(_t49);
                    _d_beta += _r17;
                    double _r18 = clad::pop(_t50) * _r_d9;
        ...
        } else {
            {
                for (; clad::back(_t59); clad::back(_t59)--) {
                    ...
                    double _r_d13 = _d_p[_t61];
                    int _t63 = clad::pop(_t62);
                    _d_r[_t63] += _r_d13;
                    double _r31 = _r_d13 * clad::pop(_t64);
                    _d_beta += _r31;
                    double _r32 = clad::pop(_t65) * _r_d13;
            ...
            {
                double _r_d12 = _d_beta;
                double _r27 = clad::pop(_t57);
                double _r28 = _r_d12 / _r27;
                _d_rtrans += _r28;
    ...
    for (; _t27; _t27--) {
        ...
        double _r_d5 = _d_r[_t29];
        int _t31 = clad::pop(_t30);
        _d_b[_t31] += _r_d5;
        double _r8 = _r_d5 * clad::pop(_t32);
        _d_beta += _r8;
        double _r9 = clad::pop(_t33) * _r_d5;
    ...
    for (; _t9; _t9--) {
        {
            for (; clad::back(_t12); clad::back(_t12)--) {
                int _t14 = clad::pop(_t13);
                double _r_d3 = _d_Ap[_t14];
                _d_Ap[_t14] += _r_d3;
                double _r4 = _r_d3 * clad::pop(_t15);
                int _t17 = clad::pop(_t16);
                int _t19 = clad::pop(_t18);
                double _r5 = clad::pop(_t20) * _r_d3;
