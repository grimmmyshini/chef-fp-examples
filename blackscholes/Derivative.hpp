namespace clad
{
    ...
    _label0:
        ...
        {
            double _r_d73 = _d_OutputX;
            _d_xLocal += _r_d73;
            _d_OutputX -= _r_d73;
        }
        {
            double _r_d72 = _d_xLocal;
            _d_xLocal += -_r_d72;
            _delta_xLocal += clad::getErrorVal(_r_d72, _EERepl_xLocal5, "xLocal");
            _d_xLocal -= _r_d72;
        }
        {
            double _r_d71 = _d_xLocal;
        ...
        {
            double _r_d53 = _d_xNPrimeofX;
            _d_expValues += _r_d53;
            _d_xNPrimeofX -= _r_d53;
        }
        {
            double _r_d52 = _d_expValues;
        ...
        {
            double _r_d47 = _d_InputX;
            _d_d2 += _r_d47;
            _d_InputX -= _r_d47;
        }
        {
            double _r_d46 = _d_NofXd1;
            _d_OutputX += _r_d46;
            _d_NofXd1 -= _r_d46;
        }
        if (_cond1)
        ...
        {
            double _r_d44 = _d_OutputX;
            _d_xLocal += _r_d44;
            _d_OutputX -= _r_d44;
        }
        {
            double _r_d43 = _d_xLocal;
            _d_xLocal += -_r_d43;
            _delta_xLocal += clad::getErrorVal(_r_d43, _EERepl_xLocal3, "xLocal");
            _d_xLocal -= _r_d43;
        }
        {
            double _r_d42 = _d_xLocal;
        ...
        {
            double _r_d24 = _d_xNPrimeofX;
            _d_expValues += _r_d24;
            _d_xNPrimeofX -= _r_d24;
        }
        {
            double _r_d23 = _d_expValues;
        ...
        {
            double _r_d7 = _d_xLogTerm;
            _d_logValues += _r_d7;
            _d_xLogTerm -= _r_d7;
        }
        {
            double _r_d6 = _d_logValues;
        ...
        {
            double _r_d5 = _d_xSqrtTime;
            double _r0 = _r_d5 * clad::custom_derivatives::sqrt_pushforward(_t0, 1.).pushforward;
            _d_xTime += _r0;
